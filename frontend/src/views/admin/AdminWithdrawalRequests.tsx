...
export const AdminWithdrawalRequests: React.FC = () => {
  ...
  if (isLoading) return <div style={{ padding: '32px' }}>Loading withdrawal requests...</div>;
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
      ...
      <div>
        <h2 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '6px' }}>Withdrawal Requests</h2>
        <p style={{ color: 'var(--text-secondary)' }}>Review and manage all user withdrawal requests.</p>
      </div>
